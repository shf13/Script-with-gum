...
git_USER_NAME=$(gum input --placeholder "Enter full name" --value "$SYSTEM_NAME" --prompt "Name> ")
git_USER_EMAIL=$(gum input --placeholder "Enter email address" --prompt "Email> ")
